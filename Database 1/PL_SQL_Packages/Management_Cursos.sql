...
------------
    ...
    BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE(chr(10) || 'SE HA MODIFICADO LA FECHA DE FINAL DEL CURSO ' || V_NUM_CURSO);
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                DBMS_OUTPUT.PUT_LINE(chr(10) || 'EL CURSO NO EXISTE Y NO SE HA PODIDO MODIFICAR');
...
------------
    ...
    BEGIN
        ...
        WHILE C1%FOUND LOOP
            ...
            DBMS_OUTPUT.PUT_LINE(chr(10) || 'EL PRECIO DE LOS CURSOS IMPARTIDOS POR EL PROFESOR DE CÓDIGO ' || V_NUM_PROF || ' SE HA INCREMENTADO CORRECTAMENTE');
            FETCH C1 INTO REG;   
        END LOOP;
        CLOSE C1;    

...
/* Bloque PL que, introduciendo primero el número de alumnos que se desean visualizar, y depués el código de un curso, muestre el nombre del curso y el nombre, correo y nota de los alumnos que están matriculados, siempre que tengan el curso aprobado */
SET SERVEROUTPUT ON
DECLARE
